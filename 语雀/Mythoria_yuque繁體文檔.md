...
| **收入來源**      | **收費結構**          | **分配模式**                              |
| ------------- | ----------------- | ------------------------------------- |
| **PVP挑戰手續費**  | 每次挑戰收取一定比例        | <p>50%玩家獎勵<br>30%AI國庫<br>20%平台運營</p>  |
| **Swap交易手續費** | Swap1和Swap2各收取10% | <p>100%進入AI國庫調控<br>部分用於節點分紅</p>       |
...
* [技術文檔](ttps://mythoria-2.gitbook.io/mythoria-docs)
